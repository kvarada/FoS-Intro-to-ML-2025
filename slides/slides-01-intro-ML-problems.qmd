...
::: {.column width="60%"}
- You hard-code rules: "If the image has prominent whiskers, small nose, round face, it's a cat."
- This works for normal cases, but what if there are exceptions (e.g., a cat is missing whiskers) 
::: 
...
::: {.column width="60%"}
- We don't tell the model the exact rule. Instead, we give it many labeled images, and it learns which features matter most.
    - small nose ✅
    - round face ✅
    - prominent whiskers ✅    
...
- No need to even specify whiskers, nose, or face shape.
::: 
